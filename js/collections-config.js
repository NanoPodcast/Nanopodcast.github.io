...
const TEXT_SCHEMA = {
  ...
  home: {
    ...
    fields: [
      ...
      { key: "home.lab1Tag", label: "Card 1 — tag pill" },
      { key: "home.lab1Title", label: "Card 1 (Interviews) title" },
      { key: "home.lab1Desc", label: "Card 1 (Interviews) description", type: "textarea" },
      { key: "home.lab2Tag", label: "Card 2 — tag pill" },
      { key: "home.lab2Title", label: "Card 2 (Knowledge) title" },
      { key: "home.lab2Desc", label: "Card 2 (Knowledge) description", type: "textarea" },
      { key: "home.lab3Tag", label: "Card 3 — tag pill" },
      { key: "home.lab3Title", label: "Card 3 (Stories) title" },
      { key: "home.lab3Desc", label: "Card 3 (Stories) description", type: "textarea" },
      { key: "home.lab4Tag", label: "Card 4 — tag pill" },
      { key: "home.lab4Title", label: "Card 4 (Production) title" },
      { key: "home.lab4Desc", label: "Card 4 (Production) description", type: "textarea" },
      { key: "home.lab5Tag", label: "Card 5 — tag pill" },
      { key: "home.lab5Title", label: "Card 5 (Episodes) title" },
      { key: "home.lab5Desc", label: "Card 5 (Episodes) description", type: "textarea" },
      { key: "home.lab6Tag", label: "Card 6 — tag pill" },
      ...
      { key: "home.statMembers", label: "Stat label: members (crew + team)" },
      { key: "home.statCrew", label: "Stat label: crew" },
      { key: "home.statEpisodes", label: "Stat label: episodes" },
      { key: "home.nextEyebrow", label: "Next-up eyebrow" },
      { key: "home.nextTitle", label: "Next-up title" },
      { key: "home.whyEyebrow", label: "\"Why join us\" eyebrow" },
      { key: "home.whyTitle", label: "\"Why join us\" title" },
      { key: "home.whyDesc", label: "\"Why join us\" description", type: "textarea" },
      { key: "home.quote1Text", label: "Quote 1 — text", type: "textarea" },
      { key: "home.quote1Name", label: "Quote 1 — member name" },
      { key: "home.quote1Role", label: "Quote 1 — role / lab" },
      { key: "home.quote2Text", label: "Quote 2 — text", type: "textarea" },
      { key: "home.quote2Name", label: "Quote 2 — member name" },
      { key: "home.quote2Role", label: "Quote 2 — role / lab" },
      { key: "home.quote3Text", label: "Quote 3 — text", type: "textarea" },
      { key: "home.quote3Name", label: "Quote 3 — member name" },
      { key: "home.quote3Role", label: "Quote 3 — role / lab" },

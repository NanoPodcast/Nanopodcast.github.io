...
const I18N = {
  en: {
    ...
    home: {
      ...
      labsDesc: "We split every season into four recurring segments so each episode goes deep on one thing, then ties it back to the bigger picture.",
  ...
  fr: {
    ...
    home: {
      ...
      labsEyebrow: "Ce que nous couvrons", labsTitle: "Quatre rubriques, une seule émission",
  ...
  ar: {
    ...
    home: {
      ...
      labsEyebrow: "ماذا نغطي", labsTitle: "أربعة أقسام، بودكاست واحد",
